...
abstract contract BaseHonkVerifier is IVerifier {
    ...
    function verifyShplemini(
        ...
        mem.shiftedScalar =
            tp.geminiR.invert() *
            (inverse_vanishing_evals[0] - (tp.shplonkNu * inverse_vanishing_evals[1]));
        ...
        for (uint256 i; i < CONST_PROOF_SIZE_LOG_N - 1; ++i) {
            ...
            mem.constantTermAccumulator =
                mem.constantTermAccumulator +
                (scalingFactor * proof.geminiAEvaluations[i + 1]);
        ...
        mem.constantTermAccumulator =
            mem.constantTermAccumulator +
            (proof.geminiAEvaluations[0] * tp.shplonkNu * inverse_vanishing_evals[1]);
